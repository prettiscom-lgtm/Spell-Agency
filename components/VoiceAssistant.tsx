...
const VoiceAssistant: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
      if (isOpen && !isMobile) {
          setPosition({
              x: window.innerWidth / 2 - (isMinimized ? 150 : 200),
              y: window.innerHeight / 2 - (isMinimized ? 50 : 275)
          });
      }
        ...
        const sessionPromise = ai.live.connect({
            ...
            config: {
                ...
                systemInstruction: `
                    ...
                    - If you hear silence, DO NOT speak. Only speak when addressed.
  ...
  // Mobile Styles vs Desktop Styles
  const containerClass = isMobile 
    ? "fixed inset-0 z-[150] bg-black text-white flex flex-col" 
    : "fixed z-[150] w-[380px] h-[550px] bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl flex flex-col overflow-hidden ring-1 ring-white/5 animate-fadeIn";
    ...
    <div style={windowStyle} className={containerClass}>
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative p-8">
            <div className="relative mb-12">
                ...
                <div className="w-40 h-40 md:w-40 md:h-40 rounded-full bg-gradient-to-b from-[#1a1a1a] to-black border border-white/10 flex items-center justify-center relative z-10 shadow-2xl">
                        {callState === 'calling' ? (
        ...
        {/* Controls */}
        <div className="h-32 md:h-24 bg-[#0a0a0a] border-t border-white/5 flex items-center justify-center gap-8 pb-8 md:pb-0">
            {callState === 'calling' ? (
                <>
                    ...
                    <button onClick={startCall} className="flex flex-col items-center gap-1 group">
                        <div className="w-20 h-20 md:w-16 md:h-16 rounded-full bg-green-500 text-white flex items-center justify-center shadow-[0_0_30px_rgba(34,197,94,0.3)] animate-pulse group-hover:scale-105 transition-transform">
